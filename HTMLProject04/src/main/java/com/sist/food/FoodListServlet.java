...
public class FoodListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (FoodVO vo:list) {
			...
			out.println("<a href=FoodDetailServlet?fno="+vo.getFno()+"><img src="+vo.getPoster()+" class=img-rounded style=\"width:240px; height:150px;\"></a>");
			out.println("</td>");
			out.println("<td width=70%><h3>");
			out.println("<a href=FoodDetailServlet?cno="+vo.getFno()+">" + vo.getName()+"</a>&nbsp;<span style=\"color:orange\">"+vo.getScore()+"</span>");
			out.println("</h3></td>");
			out.println("</tr>");
			out.println("<tr>");

...
<body>
	...
	<table class="table">
		...
		<tr>
			<td colspan="2">
				<pre>public void _jspService(<mark><strong>HttpServletRequest request, HttpServletResponse response</strong></mark>)
    			{
					<mark>PageContext pageContext;</mark>
				    <mark>HttpSession session = null;</mark>
				    <mark>ServletContext application;</mark>
				    <mark>ServletConfig config;</mark>
				    <mark>JspWriter out = null;</mark>
				    <mark>Object page = this;</mark>
					JSP코딩영역
				}</pre>
			</td>
		</tr>

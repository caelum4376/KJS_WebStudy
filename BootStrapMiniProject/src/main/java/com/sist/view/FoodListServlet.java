...
public class FoodListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (FoodVO vo:list) {
			...
			out.println("<a href=FoodDetailBeforeServlet?mode=3&fno="+vo.getFno()+"><img src="+vo.getPoster()+" class=img-rounded style=\"width:240px; height:150px;\"></a>");
			out.println("</td>");
		...
		if (cookies != null) {
			for (int i=cookies.length-1; i>=0; i--) { // 가장 최근데이터를 먼저 읽어 온다

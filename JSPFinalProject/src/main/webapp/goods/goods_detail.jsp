...
<%--
		...
		2) 서버
			=> Front Controller (DispatcherServlet)
				...
				--------------------------------------------------------------
				배달부(DispatcherServlet)
			=> 모델 : request가 JSP전송
					  -------
					  request.seetAttribute() : 데이터를 추가해서 전송할 목적
	...
	<main class="container clear">
		<div class="row">
			<table class="table">
				...
				<tr>
					<td><span style="color:red;">${ vo.goods_discount }%</span>
				...
				<tr>
					<td>배송일&nbsp;&nbsp;<span style="color:gray;">${ vo.goods_delivery }</span></td>
				</tr>
				<tr>
					<td class="inline">
				...
				<tr>
					<td class="text-right inline"><span style="color:gray;">${ vo.goods_sub }</span></td>
				</tr>
				<tr>

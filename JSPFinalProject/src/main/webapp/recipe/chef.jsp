						...
						<td>
							<c:forEach var="vo" items="${ list }">
								<table class="table">
									...
									<tr>
										<td><img src="images/mem1.png">&nbsp;${ vo.mem_cont1 }</td>
										<td><img src="images/mem2.png">&nbsp;${ vo.mem_cont2 }</td>
										<td><img src="images/mem3.png">&nbsp;${ vo.mem_cont7 }</td>
										<td><img src="images/mem4.png">&nbsp;${ vo.mem_cont3 }</td>
									</tr>
								</table>
							</c:forEach>
						</td>

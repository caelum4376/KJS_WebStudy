...
public class StudentUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<td width=65%;>");
		out.println("<input type=number name=kor size=10 class=input-sm max=100 min=0 step=5 value="+vo.getKor()+">");
		out.println("</td>");
		out.println("</tr>");
		...
		out.println("<td width=65%;>");
		out.println("<input type=number name=eng size=10 class=input-sm max=100 min=0 step=5 value="+vo.getEng()+">");
		out.println("</td>");
		out.println("</tr>");
		...
		out.println("<td width=65%;>");
		out.println("<input type=number name=math size=10 class=input-sm max=100 min=0 step=5 value="+vo.getMath()+">");
		out.println("</td>");
		out.println("</tr>");
